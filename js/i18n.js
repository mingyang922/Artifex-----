...
const TRANSLATIONS = {
    ...
    'productivity.routeHome': { zh: '工作台', zht: '工作台', en: 'Dashboard', ja: 'ダッシュボード', ko: '대시보드' },
    ...
    'ai.expandPixels': { zh: '扩展像素', zht: '擴展像素', en: 'Expansion (px)', ja: '拡張ピクセル', ko: '확장 픽셀' },
    ...
    'assets.deselectAll': { zh: '取消选择', zht: '取消選取', en: 'Deselect all', ja: '選択を解除', ko: '선택 해제' },
    'assets.batchDelete': {
        zh: '批量删除',
        zht: '批次刪除',
        en: 'Delete selected',
