...
function createBootScreen() {
    ...
    // Regional themes already provide their own visual identity. Showing the
    // cyberpunk boot overlay would cause an obvious old-theme flash.
    if (document.documentElement.matches('[class*="theme-"]')) return;
