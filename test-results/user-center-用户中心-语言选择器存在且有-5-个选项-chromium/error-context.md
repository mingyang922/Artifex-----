...
- Name: user-center.spec.js >> 用户中心 >> 语言选择器存在且有 5 个选项
- Location: e2e\user-center.spec.js:70:5
  ...
  - generic [ref=e3]:
    ...
    - generic [ref=e7]:
      ...
      - generic [ref=e11]:
        - generic [ref=e12]:
          - generic [ref=e13]: 
          - textbox "用户名" [ref=e14]: e2euc1780926077913
        - generic [ref=e15]:
          - generic [ref=e16]: 
          - textbox "邮箱地址" [ref=e17]: e2e-uc-1780926077731@test.com
        - generic [ref=e18]:
          - generic [ref=e19]: 
          - generic [ref=e20]:
